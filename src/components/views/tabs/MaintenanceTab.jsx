...
function TicketModal({ buildingId, units = [], userId, ticket, onClose, staffList = [] }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[580px] max-h-[90vh] overflow-y-auto">
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-4">
        {loading ? (
          <div className="py-10 text-center text-zinc-400 text-[14px]">Loading tickets…</div>
        ) : filtered.length === 0 ? (
